-- Create missing AI conversation memory table and related structures
-- Run this in your Supabase SQL Editor

-- Create the ai_conversation_memory table
...
-- Create user_features table for enhanced features
...
SELECT 'ai_conversation_memory table created' as status
WHERE EXISTS (
...
SELECT 'user_features table created' as status
WHERE EXISTS (
    SELECT 1 FROM information_schema.tables 
