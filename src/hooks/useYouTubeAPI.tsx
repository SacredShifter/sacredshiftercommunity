...
export const useYouTubeAPI = () => {
  ...
  const getChannelVideos = useCallback(async (
    ...
    try {
      ...
      const videos: YouTubeVideo[] = videoData.items.map((video: { id: string; snippet: { title: string; description: string; thumbnails: { high: { url: string; }; default: { url: string; }; }; publishedAt: string; channelId: string; channelTitle: string; }; contentDetails: { duration: string; }; statistics: { viewCount: string; }; }) => ({
        id: video.id,
  ...
  const getChannelPlaylists = useCallback(async (
    ...
    try {
      ...
      const playlists: YouTubePlaylist[] = data.items.map((playlist: { id: string; snippet: { title: string; description: string; thumbnails: { high: { url: string; }; default: { url: string; }; }; publishedAt: string; }; contentDetails: { itemCount: string; }; }) => ({
        id: playlist.id,
