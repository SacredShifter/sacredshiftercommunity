...
export const ParallaxBackground = () => {
  ...
  useEffect(() => {
    ...
    // Create gentle rotation animation without scroll dependency
    ...
    return () => {
      ...
      if (l1) gsap.killTweensOf(l1);
      if (l2) gsap.killTweensOf(l2);
      if (l3) gsap.killTweensOf(l3);
    };
  }, []);
  ...
  return (
    ...
    >
      ...
      <div 
        ref={layer1Ref}
        className="cosmic-grid-layer absolute inset-0 opacity-30"
        style={{
      ...
      <div 
        ref={layer2Ref}
        className="cosmic-grid-layer absolute inset-0 opacity-25"
        style={{
