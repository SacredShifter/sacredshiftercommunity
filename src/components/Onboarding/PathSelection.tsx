          ...
          return (
            ...
            >
              <Button
                ...
                className="w-full h-auto p-6 text-left border-primary/20 hover:border-primary/50 bg-background/50 hover:bg-primary/5 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-primary/10"
              >
                <div className="space-y-4">
                  {/* Icon and Energy */}
                  <div className="flex items-start justify-between">
                    <div className={`p-3 rounded-full bg-gradient-to-br ${path.gradient} group-hover:scale-110 transition-transform duration-300`}>
                      <IconComponent className={`h-6 w-6 text-${path.color}-600`} />
                    </div>
