...
interface EntryFormProps {
  ...
  onClose: () => void;
  onSuccess: () => void;
  editEntry?: NewRegistryEntry & { id: string };
}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: 'Personal' | 'Collective' | 'Transmission') => setFormData(prev => ({ ...prev, entry_type: value }))}
                >
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: 'text' | 'markdown' | 'rich_text') => setFormData(prev => ({ ...prev, content_type: value }))}
                >
                  <SelectTrigger className="bg-background/50">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: 'Private' | 'Circle' | 'Public') => setFormData(prev => ({ ...prev, access_level: value }))}
                >
                  <SelectTrigger className="bg-background/50">
                    <SelectValue />
                  </SelectTrigger>
