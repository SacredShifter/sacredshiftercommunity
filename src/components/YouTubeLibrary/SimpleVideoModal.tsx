...
export const SimpleVideoModal: React.FC<VideoPlayerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div 
        ref={modalRef}
        className="relative w-full max-w-6xl h-[90vh] bg-background/95 backdrop-blur-md border border-border/30 rounded-lg overflow-hidden"
      >
          ...
          <div className="p-6 pb-4 border-b border-border/30">
            <div className="flex items-start justify-between">
              <div className="flex-1 min-w-0">
                <h2 className="text-xl font-semibold leading-tight line-clamp-2 text-foreground">
                  {video.title}
                </h2>
