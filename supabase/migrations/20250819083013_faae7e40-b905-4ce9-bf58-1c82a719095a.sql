-- Aura Sovereignty System - Complete Implementation (Fixed)
...
CREATE TABLE IF NOT EXISTS aura_preferences (
  ...
  intervention_type TEXT NOT NULL UNIQUE,          -- e.g. "send_message", "style_change"
...
-- Add feedback_type column to existing community_feedback table
ALTER TABLE community_feedback 
ADD COLUMN IF NOT EXISTS feedback_type TEXT DEFAULT 'audit_response',
ADD COLUMN IF NOT EXISTS refusal_id UUID REFERENCES aura_refusal_log(id);
